...
!!      convert integer to string
 ...
 1000 format (a4,2x,i4,2x,a5,a4,2x,i5,1x,i4,1x,i4,f10.5,66f10.3,1x,
     *e10.5,1x,e10.5,5e10.3)
 2000 format (a4,2x,i4,2x,a5,a4,2x,i5,1x,i4,1x,i4,f10.5,66f10.3,1x,
     *e10.5,1x,e10.5,5e10.3,1x,i4)
 1001 format (a4,2x,i4,2x,a5,a4,2x,i5,1x,i4,1x,i4,f10.5,66f10.3,1x,
